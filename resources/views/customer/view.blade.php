                      ...
                      <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                           ...
                           <div class="mt-4"></div>
                            ...
                            @isset($customer->Patient->weight)
                            <p><b>{{ __('sentence.Weight') }} :</b> {{ $customer->Patient->weight }} Kg</p>
                            @endisset

                            @isset($customer->Patient->height)
                            <p><b>{{ __('sentence.Height') }} :</b> {{ $customer->Patient->height }} cm</p>
                            @endisset

                            @isset($customer->Patient->blood)
                            <p><b>{{ __('sentence.Blood Group') }} :</b> {{ $customer->Patient->blood }}</p>
                            @endisset
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p><b>{{ __('sentence.Patient') }} :</b> <span id="customer_name"></span></p>
