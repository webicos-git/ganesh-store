                  ...
                  <div class="row">
                    <div class="col-md-4 col-sm-6">
                      <center><img src="<?php echo e(asset('img/patient-icon.png')); ?>" class="img-profile rounded-circle img-fluid"></center>
                       <h4 class="text-center"><b><?php echo e($customer->name); ?></b></h4>
                            <hr>
                            <?php if(isset($customer->email)): ?>
                            <p><b><?php echo e('Email'); ?> :</b> <?php echo e($customer->email); ?></p>
                            <?php endif; ?>
                            
                            <?php if(isset($customer->phone)): ?>
                            <p><b><?php echo e(__('sentence.Phone')); ?> :</b> <?php echo e($customer->phone); ?></p>
                            <?php endif; ?>

                            <?php if(isset($customer->address)): ?>
                            <p><b><?php echo e(__('sentence.Address')); ?> :</b> <?php echo e($customer->address); ?></p>
                            <?php endif; ?>
                    </div>
                      ...
                      <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                           ...
                           <div class="mt-4"></div>
                            ...
                            <?php if(isset($customer->Patient->weight)): ?>
                            <p><b><?php echo e(__('sentence.Weight')); ?> :</b> <?php echo e($customer->Patient->weight); ?> Kg</p>
                            <?php endif; ?>

                            <?php if(isset($customer->Patient->height)): ?>
                            <p><b><?php echo e(__('sentence.Height')); ?> :</b> <?php echo e($customer->Patient->height); ?> cm</p>
                            <?php endif; ?>

                            <?php if(isset($customer->Patient->blood)): ?>
                            <p><b><?php echo e(__('sentence.Blood Group')); ?> :</b> <?php echo e($customer->Patient->blood); ?></p>
                            <?php endif; ?>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p><b><?php echo e(__('sentence.Patient')); ?> :</b> <span id="customer_name"></span></p>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\projects\ganesh-store\resources\views/customer/view.blade.php ENDPATH**/ ?>